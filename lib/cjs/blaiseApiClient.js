...
var BlaiseApiClient = /** @class */ (function () {
    ...
    BlaiseApiClient.url = function (url) {
        if (!url.startsWith('/')) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4 /*yield*/, this.httpClient.get("" + this.blaiseApiUrl + BlaiseApiClient.url(url), config)];
                    case 2:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4 /*yield*/, this.httpClient.post("" + this.blaiseApiUrl + BlaiseApiClient.url(url), data, config)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4 /*yield*/, this.httpClient.delete("" + this.blaiseApiUrl + BlaiseApiClient.url(url), config)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4 /*yield*/, this.httpClient.patch("" + this.blaiseApiUrl + BlaiseApiClient.url(url), data, config)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
...
__exportStar(require("./interfaces/survey"), exports);
