...
var editing = __importStar(require("./functions/editingFunctions"));
var BlaiseApiClient = /** @class */ (function () {
    function BlaiseApiClient(blaiseApiUrl, config) {
        ...
        this.getEditingDetails = editing.getEditingDetails;
...
__exportStar(require("./interfaces/editing"), exports);
...
__exportStar(require("./mockObjects/editingMockObjects"), exports);
