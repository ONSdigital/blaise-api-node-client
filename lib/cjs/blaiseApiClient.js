...
var reports = __importStar(require("./functions/reportFunctions"));
var BlaiseApiClient = /** @class */ (function () {
    function BlaiseApiClient(blaiseApiUrl, config) {
        ...
        this.getReportData = reports.getReportData;
...
__exportStar(require("./interfaces/report"), exports);
...
__exportStar(require("./mockObjects/reportMockObjects"), exports);
