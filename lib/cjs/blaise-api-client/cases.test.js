...
describe("blaiseApiClient", function () {
    ...
    describe("get cases status", function () {
        ...
        var questionnaireName = "dst2108t";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/cases/status").reply(200, blaise_api_client_1.CaseStatusListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it("gets all cases and outcome codes for a given questionnaire", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        expect(result).toEqual(blaise_api_client_1.CaseStatusListMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
