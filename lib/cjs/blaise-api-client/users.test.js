...
var users_mock_objects_1 = require("../mock-objects/users.mock.objects");
...
describe("blaiseApiClient users", function () {
    ...
    describe("create user", function () {
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/users").reply(201, users_mock_objects_1.CreateUserResponseMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it("creates a user and returns a response", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.createUser(users_mock_objects_1.CreateUserMockObject)];
                    case 1:
                        createUser = _a.sent();
    ...
    describe("delete user", function () {
        ...
        beforeEach(function () {
            mock.onDelete("http://" + blaiseApiUrl + "/api/v2/users/" + userName).reply(204, null);
        });
        afterEach(function () {
            mock.reset();
        });
