...
var blaise_api_client_1 = __importStar(require("../blaise-api-client"));
var mock = new axios_mock_adapter_1.default(axios_1.default, { onNoMatch: "throwException" });
var blaiseApiUrl = "testUri";
var blaiseApiClient = new blaise_api_client_1.default("http://" + blaiseApiUrl);
describe("blaiseApiClient", function () {
    describe("get all questionnaires with Cati data", function () {
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/questionnaires").reply(200, blaise_api_client_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(questionnaires).toEqual(blaise_api_client_1.QuestionnaireListMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("get questionnaires with Cati data", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires").reply(200, blaise_api_client_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("get questionnaire with Cati data", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + blaise_api_client_1.QuestionnaireMockObject.name).reply(200, blaise_api_client_1.QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns an questionnaire including CATI data", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaireWithCatiData(serverpark, blaise_api_client_1.QuestionnaireMockObject.name)];
                    case 1:
                        questionnaire = _a.sent();
                        expect(questionnaire).toEqual(blaise_api_client_1.QuestionnaireMockObject);
                        expect(blaise_api_client_1.surveyIsActive(questionnaire.surveyDays)).toBeFalsy();
                        expect(blaise_api_client_1.surveyIsActiveToday(questionnaire.surveyDays)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("get questionnaires", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires").reply(200, blaise_api_client_1.QuestionnaireListMockObject);
        });
        /v2/;
        afterEach(function () {
            mock.reset();
    ...
    describe("get questionnaire", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaise_api_client_1.QuestionnaireMockObject.name).reply(200, blaise_api_client_1.QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a questionnaire", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaire(serverpark, blaise_api_client_1.QuestionnaireMockObject.name)];
                    case 1:
                        questionnaire = _a.sent();
                        expect(questionnaire).toEqual(blaise_api_client_1.QuestionnaireMockObject);
                        expect(blaise_api_client_1.surveyIsActive(questionnaire.surveyDays)).toBeFalsy();
    ...
    describe("get whether questionnaire has mode", function () {
        ...
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaise_api_client_1.QuestionnaireMockObject.name + "/modes/" + hasMode).reply(200, true);
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaise_api_client_1.QuestionnaireMockObject.name + "/modes/" + doesntHaveMode).reply(200, false);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns true if questionnaire has mode", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.doesQuestionnaireHaveMode(serverpark, blaise_api_client_1.QuestionnaireMockObject.name, hasMode)];
                    case 1:
                        exists = _a.sent();
                        expect(exists).toEqual(true);
                        return [2 /*return*/];
        ...
        it("returns false if questionnaire does not have mode", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.doesQuestionnaireHaveMode(serverpark, blaise_api_client_1.QuestionnaireMockObject.name, doesntHaveMode)];
                    case 1:
                        exists = _a.sent();
                        expect(exists).toEqual(false);
                        return [2 /*return*/];
    ...
    describe("installquestionnaire", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires").reply(201, blaise_api_client_1.InstallQuestionnaireResponseMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it("installs an questionnaire and returns the questionnaire file", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.installQuestionnaire(serverpark, blaise_api_client_1.InstallQuestionnaireMockObject)];
                    case 1:
                        questionnaire = _a.sent();
                        expect(questionnaire).toEqual(blaise_api_client_1.InstallQuestionnaireResponseMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("delete questionnaire", function () {
        ...
        beforeEach(function () {
            mock.onDelete("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "?name=" + questionnaireName).reply(204, null);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("get questionnaire modes", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaise_api_client_1.QuestionnaireMockObject.name + "/modes").reply(200, ["CATI", "CAWI"]);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns list of modes for questionnaire", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaireModes(serverpark, blaise_api_client_1.QuestionnaireMockObject.name)];
                    case 1:
                        exists = _a.sent();
    ...
    describe("get questionnaire settings", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaise_api_client_1.QuestionnaireMockObject.name + "/settings").reply(200, blaise_api_client_1.QuestionnaireSettingsMockList);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns list of settings for questionnaire", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaireSettings(serverpark, blaise_api_client_1.QuestionnaireMockObject.name)];
                    case 1:
                        exists = _a.sent();
                        expect(exists).toEqual(blaise_api_client_1.QuestionnaireSettingsMockList);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("get daybatch", function () {
        ...
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/daybatch").reply(200, blaise_api_client_1.QuestionnaireDaybatchCasesMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a list of case IDs in the current daybatch", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        daybatch = _a.sent();
                        expect(daybatch).toEqual(blaise_api_client_1.QuestionnaireDaybatchCasesMock);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("add daybatch", function () {
        ...
        var questionnaireName = "dst2108t";
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/daybatch").reply(201, blaise_api_client_1.QuestionnaireDaybatchCasesMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("installs an questionnaire and returns the questionnaire file", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.addDaybatch(serverpark, questionnaireName, blaise_api_client_1.AddDaybatchMock)];
                    case 1:
                        daybatch = _a.sent();
                        expect(daybatch).toEqual(blaise_api_client_1.QuestionnaireDaybatchCasesMock);
                        return [2 /*return*/];
    ...
    describe("get survey days", function () {
        ...
        var questionnaireName = "dst2108t";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/surveydays").reply(200, blaise_api_client_1.SurveyDaysMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a list of surveydays", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        surveyDays = _a.sent();
                        expect(surveyDays).toEqual(blaise_api_client_1.SurveyDaysMock);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("add survey days", function () {
        ...
        var questionnaireName = "dst2108t";
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/surveydays").reply(201, blaise_api_client_1.SurveyDaysMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("adds surveydays by strings", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.addSurveyDays(serverpark, questionnaireName, blaise_api_client_1.SurveyDaysMock)];
                    case 1:
                        surveyDays = _a.sent();
                        expect(surveyDays).toEqual(blaise_api_client_1.SurveyDaysMock);
                        return [2 /*return*/];
        ...
        it("adds surveydays by dates", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.addSurveyDays(serverpark, questionnaireName, blaise_api_client_1.SurveyDaysDatesMock)];
                    case 1:
                        surveyDays = _a.sent();
                        expect(surveyDays).toEqual(blaise_api_client_1.SurveyDaysMock);
                        return [2 /*return*/];
