...
exports.InstrumentSettingsMockList = exports.InstallInstrumentResponseMockObject = exports.InstallInstrumentMockObject = exports.InstrumentMockObject = exports.InstrumentListMockObject = exports.DiagnosticMockObject = void 0;
...
var BlaiseApiClient = /** @class */ (function () {
    function BlaiseApiClient(blaise_api_url, timeoutInMs) {
    ...
    BlaiseApiClient.prototype.patch = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.patch("" + this.blaise_api_url + this.url(url))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
