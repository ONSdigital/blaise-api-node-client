...
var cases_interface_1 = require("./interfaces/cases.interface");
Object.defineProperty(exports, "Outcome", { enumerable: true, get: function () { return cases_interface_1.Outcome; } });
...
var questionnaires = __importStar(require("./blaise-api-client/questionnaires"));
...
var BlaiseApiClient = /** @class */ (function () {
    function BlaiseApiClient(blaiseApiUrl, config) {
        ...
        this.getDaybatch = questionnaires.getDaybatch;
        this.addDaybatch = questionnaires.addDaybatch;
        this.getSurveyDays = questionnaires.getSurveyDays;
        this.addSurveyDays = questionnaires.addSurveyDays;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4 /*yield*/, this.httpClient.patch("" + this.blaiseApiUrl + this.url(url), data, config)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
...
__exportStar(require("./interfaces/questionnaires.interface"), exports);
__exportStar(require("./interfaces/diagnostics.interface"), exports);
__exportStar(require("./interfaces/cases.interface"), exports);
__exportStar(require("./interfaces/users.interface"), exports);
__exportStar(require("./survey-days"), exports);
__exportStar(require("./mock-objects/cases.mock.objects"), exports);
__exportStar(require("./mock-objects/diagnostics.mock.objects"), exports);
__exportStar(require("./mock-objects/questionnaires.mock.objects"), exports);
__exportStar(require("./mock-objects/users.mock.objects"), exports);
