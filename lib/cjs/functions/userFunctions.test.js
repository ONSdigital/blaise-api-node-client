...
var userMockObjects_1 = require("../mockObjects/userMockObjects");
...
describe('blaiseApiClient users', function () {
    ...
    describe('create user', function () {
        beforeEach(function () {
            mock.onPost("http://".concat(blaiseApiUrl, "/api/v2/users")).reply(201, userMockObjects_1.CreateUserResponseMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it('creates a user and returns a response', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.createUser(userMockObjects_1.CreateUserMockObject)];
                    case 1:
                        createUser = _a.sent();
