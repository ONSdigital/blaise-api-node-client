...
var blaiseApiClient = new blaiseApiClient_1.default("http://".concat(blaiseApiUrl));
describe('blaiseApiClient', function () {
    describe('get all questionnaires with Cati data', function () {
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/cati/questionnaires")).reply(200, blaiseApiClient_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(questionnaires).toEqual(blaiseApiClient_1.QuestionnaireListMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('get questionnaires with Cati data', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/cati/serverparks/").concat(serverpark, "/questionnaires")).reply(200, blaiseApiClient_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaire with Cati data', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/cati/serverparks/").concat(serverpark, "/questionnaires/").concat(blaiseApiClient_1.QuestionnaireMockObject.name)).reply(200, blaiseApiClient_1.QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it('returns an questionnaire including CATI data', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaireWithCatiData(serverpark, blaiseApiClient_1.QuestionnaireMockObject.name)];
                    case 1:
                        questionnaire = _a.sent();
                        expect(questionnaire).toEqual(blaiseApiClient_1.QuestionnaireMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('get questionnaires', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires")).reply(200, blaiseApiClient_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaire', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(blaiseApiClient_1.QuestionnaireMockObject.name)).reply(200, blaiseApiClient_1.QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it('returns a questionnaire', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaire(serverpark, blaiseApiClient_1.QuestionnaireMockObject.name)];
                    case 1:
                        questionnaire = _a.sent();
                        expect(questionnaire).toEqual(blaiseApiClient_1.QuestionnaireMockObject);
                        return [2 /*return*/];
    ...
    describe('get whether questionnaire has mode', function () {
        ...
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(blaiseApiClient_1.QuestionnaireMockObject.name, "/modes/").concat(hasMode)).reply(200, true);
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(blaiseApiClient_1.QuestionnaireMockObject.name, "/modes/").concat(doesntHaveMode)).reply(200, false);
        });
        afterEach(function () {
            mock.reset();
        });
        it('returns true if questionnaire has mode', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.doesQuestionnaireHaveMode(serverpark, blaiseApiClient_1.QuestionnaireMockObject.name, hasMode)];
                    case 1:
                        exists = _a.sent();
                        expect(exists).toEqual(true);
                        return [2 /*return*/];
        ...
        it('returns false if questionnaire does not have mode', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.doesQuestionnaireHaveMode(serverpark, blaiseApiClient_1.QuestionnaireMockObject.name, doesntHaveMode)];
                    case 1:
                        exists = _a.sent();
                        expect(exists).toEqual(false);
                        return [2 /*return*/];
    ...
    describe('installquestionnaire', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onPost("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires")).reply(201, blaiseApiClient_1.InstallQuestionnaireResponseMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it('installs an questionnaire and returns the questionnaire file', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.installQuestionnaire(serverpark, blaiseApiClient_1.InstallQuestionnaireMockObject)];
                    case 1:
                        questionnaire = _a.sent();
                        expect(questionnaire).toEqual(blaiseApiClient_1.InstallQuestionnaireResponseMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('get questionnaire modes', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(blaiseApiClient_1.QuestionnaireMockObject.name, "/modes")).reply(200, ['CATI', 'CAWI']);
        });
        afterEach(function () {
            mock.reset();
        });
        it('returns list of modes for questionnaire', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaireModes(serverpark, blaiseApiClient_1.QuestionnaireMockObject.name)];
                    case 1:
                        exists = _a.sent();
    ...
    describe('get questionnaire settings', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(blaiseApiClient_1.QuestionnaireMockObject.name, "/settings")).reply(200, blaiseApiClient_1.QuestionnaireSettingsMockList);
        });
        afterEach(function () {
            mock.reset();
        });
        it('returns list of settings for questionnaire', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.getQuestionnaireSettings(serverpark, blaiseApiClient_1.QuestionnaireMockObject.name)];
                    case 1:
                        exists = _a.sent();
                        expect(exists).toEqual(blaiseApiClient_1.QuestionnaireSettingsMockList);
                        return [2 /*return*/];
                }
            });
        }); });
