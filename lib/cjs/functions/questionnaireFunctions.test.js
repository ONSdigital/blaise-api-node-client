...
describe('blaiseApiClient', function () {
    describe('get all questionnaires with Cati data', function () {
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/questionnaires").reply(200, blaiseApiClient_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaires with Cati data', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires").reply(200, blaiseApiClient_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaire with Cati data', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + blaiseApiClient_1.QuestionnaireMockObject.name).reply(200, blaiseApiClient_1.QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaires', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires").reply(200, blaiseApiClient_1.QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaire', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaiseApiClient_1.QuestionnaireMockObject.name).reply(200, blaiseApiClient_1.QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get whether questionnaire has mode', function () {
        ...
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaiseApiClient_1.QuestionnaireMockObject.name + "/modes/" + hasMode).reply(200, true);
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaiseApiClient_1.QuestionnaireMockObject.name + "/modes/" + doesntHaveMode).reply(200, false);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('installquestionnaire', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires").reply(201, blaiseApiClient_1.InstallQuestionnaireResponseMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaire modes', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaiseApiClient_1.QuestionnaireMockObject.name + "/modes").reply(200, ['CATI', 'CAWI']);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get questionnaire settings', function () {
        var serverpark = 'test';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + blaiseApiClient_1.QuestionnaireMockObject.name + "/settings").reply(200, blaiseApiClient_1.QuestionnaireSettingsMockList);
        });
        afterEach(function () {
            mock.reset();
        });
