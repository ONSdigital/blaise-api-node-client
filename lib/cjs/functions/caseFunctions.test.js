...
describe('blaiseApiClient', function () {
    ...
    describe('get cases status', function () {
        ...
        var questionnaireName = 'dst2108t';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(questionnaireName, "/cases/status")).reply(200, blaiseApiClient_1.CaseStatusListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
        it('gets all cases and outcome codes for a given questionnaire', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        expect(result).toEqual(blaiseApiClient_1.CaseStatusListMockObject);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('get case edit information', function () {
        ...
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/serverparks/").concat(serverpark, "/questionnaires/").concat(questionnaireName, "/cases/edit")).reply(200, blaiseApiClient_1.CaseEditInformationListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        editingDetailsListResponse.forEach(function (editingDetailsResponse, index) {
                            expect(editingDetailsResponse.primaryKey).toEqual(blaiseApiClient_1.CaseEditInformationListMockObject[index].primaryKey);
                            expect(editingDetailsResponse.outcome).toEqual(blaiseApiClient_1.CaseEditInformationListMockObject[index].outcome);
                            expect(editingDetailsResponse.assignedTo).toEqual(blaiseApiClient_1.CaseEditInformationListMockObject[index].assignedTo);
                            expect(editingDetailsResponse.editedStatus).toEqual(blaiseApiClient_1.CaseEditInformationListMockObject[index].editedStatus);
                            expect(editingDetailsResponse.interviewer).toEqual(blaiseApiClient_1.CaseEditInformationListMockObject[index].interviewer);
