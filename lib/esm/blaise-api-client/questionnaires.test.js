...
import BlaiseApiClient, { QuestionnaireListMockObject, QuestionnaireMockObject, InstallQuestionnaireMockObject, InstallQuestionnaireResponseMockObject, QuestionnaireSettingsMockList, QuestionnaireDaybatchCasesMock, AddDaybatchMock, SurveyDaysMock, SurveyDaysDatesMock, surveyIsActive, surveyIsActiveToday } from "../blaise-api-client";
var mock = new MockAdapter(axios, { onNoMatch: "throwException" });
var blaiseApiUrl = "testUri";
var blaiseApiClient = new BlaiseApiClient("http://" + blaiseApiUrl);
describe("blaiseApiClient", function () {
    describe("get all questionnaires with Cati data", function () {
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/questionnaires").reply(200, QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("get questionnaires with Cati data", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires").reply(200, QuestionnaireListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("get questionnaire with Cati data", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + QuestionnaireMockObject.name).reply(200, QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(surveyIsActive(questionnaire.surveyDays)).toBeFalsy();
                        expect(surveyIsActiveToday(questionnaire.surveyDays)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("get questionnaires", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires").reply(200, QuestionnaireListMockObject);
        });
        /v2/;
        afterEach(function () {
            mock.reset();
    ...
    describe("get questionnaire", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + QuestionnaireMockObject.name).reply(200, QuestionnaireMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("installquestionnaire", function () {
        var serverpark = "test";
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires").reply(201, InstallQuestionnaireResponseMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("add daybatch", function () {
        ...
        var questionnaireName = "dst2108t";
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/daybatch").reply(201, QuestionnaireDaybatchCasesMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("installs an questionnaire and returns the questionnaire file", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.addDaybatch(serverpark, questionnaireName, AddDaybatchMock)];
                    case 1:
                        daybatch = _a.sent();
                        expect(daybatch).toEqual(QuestionnaireDaybatchCasesMock);
                        return [2 /*return*/];
    ...
    describe("add survey days", function () {
        ...
        var questionnaireName = "dst2108t";
        beforeEach(function () {
            mock.onPost("http://" + blaiseApiUrl + "/api/v2/cati/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/surveydays").reply(201, SurveyDaysMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("adds surveydays by strings", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.addSurveyDays(serverpark, questionnaireName, SurveyDaysMock)];
                    case 1:
                        surveyDays = _a.sent();
                        expect(surveyDays).toEqual(SurveyDaysMock);
                        return [2 /*return*/];
        ...
        it("adds surveydays by dates", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blaiseApiClient.addSurveyDays(serverpark, questionnaireName, SurveyDaysDatesMock)];
                    case 1:
                        surveyDays = _a.sent();
                        expect(surveyDays).toEqual(SurveyDaysMock);
                        return [2 /*return*/];
