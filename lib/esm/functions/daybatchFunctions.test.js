...
import BlaiseApiClient, { QuestionnaireDaybatchCasesMock, AddDaybatchMock, SurveyDaysMock, SurveyDaysDatesMock, } from '../blaiseApiClient';
...
describe('blaiseApiClient', function () {
    describe('get daybatch', function () {
        ...
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/cati/serverparks/").concat(serverpark, "/questionnaires/").concat(questionnaireName, "/daybatch")).reply(200, QuestionnaireDaybatchCasesMock);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('add daybatch', function () {
        ...
        var questionnaireName = 'dst2108t';
        beforeEach(function () {
            mock.onPost("http://".concat(blaiseApiUrl, "/api/v2/cati/serverparks/").concat(serverpark, "/questionnaires/").concat(questionnaireName, "/daybatch")).reply(201, QuestionnaireDaybatchCasesMock);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get survey days', function () {
        ...
        var questionnaireName = 'dst2108t';
        beforeEach(function () {
            mock.onGet("http://".concat(blaiseApiUrl, "/api/v2/cati/serverparks/").concat(serverpark, "/questionnaires/").concat(questionnaireName, "/surveydays")).reply(200, SurveyDaysMock);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('add survey days', function () {
        ...
        var questionnaireName = 'dst2108t';
        beforeEach(function () {
            mock.onPost("http://".concat(blaiseApiUrl, "/api/v2/cati/serverparks/").concat(serverpark, "/questionnaires/").concat(questionnaireName, "/surveydays")).reply(201, SurveyDaysMock);
        });
        afterEach(function () {
            mock.reset();
        });
