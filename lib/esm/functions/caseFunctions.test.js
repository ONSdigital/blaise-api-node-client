...
describe('blaiseApiClient', function () {
    ...
    describe('get cases status', function () {
        ...
        var questionnaireName = 'dst2108t';
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/cases/status").reply(200, CaseStatusListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe('get case edit information', function () {
        ...
        beforeEach(function () {
            mock.onGet("http://" + blaiseApiUrl + "/api/v2/serverparks/" + serverpark + "/questionnaires/" + questionnaireName + "/cases/edit").reply(200, CaseEditInformationListMockObject);
        });
        afterEach(function () {
            mock.reset();
        });
