export var InstrumentListMockObject = [{
        name: "OPN2101A",
...
export var InstrumentMockObject = {
    name: "OPN2101A",
    serverParkName: "gusty",
    installDate: "2021-01-15T14:41:29.4399898+00:00",
    status: "Active",
...
export var InstallInstrumentMockObject = {
    instrumentName: "OPN2004A",
    instrumentFile: "OPN2004A.bpkg",
    bucketPath: "/"
};
export var InstallInstrumentResponseMockObject = {
    instrumentFile: "OPN2004A.bpkg"
};
export var InstrumentSettingsMockList = [
    {
...
export var InstrumentDaybatchCasesMock = [
    {
