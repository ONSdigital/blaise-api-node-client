...
describe("blaiseApiClient", () => {
    describe("get all questionnaires with Cati data", () => {
        beforeEach(() => {
            mock.onGet(`http://${blaiseApiUrl}/api/v2/cati/questionnaires`).reply(200,
            QuestionnaireListMockObject,
            );
        });
    ...
    describe("get questionnaires with Cati data", () => {
        ...
        beforeEach(() => {
            mock.onGet(`http://${blaiseApiUrl}/api/v2/cati/serverparks/${serverpark}/questionnaires`).reply(200,
            QuestionnaireListMockObject,
            );
        });
    ...
    describe("get questionnaire with Cati data", () => {
        ...
        beforeEach(() => {
            mock.onGet(`http://${blaiseApiUrl}/api/v2/cati/serverparks/${serverpark}/questionnaires/${QuestionnaireMockObject.name}`).reply(200,
            QuestionnaireMockObject,
            );
        });
    ...
    describe("get questionnaires", () => {
        ...
        beforeEach(() => {
            mock.onGet(`http://${blaiseApiUrl}/api/v2/serverparks/${serverpark}/questionnaires`).reply(200,
            QuestionnaireListMockObject,
            );
        });/v2/
    ...
    describe("get questionnaire", () => {
        ...
        beforeEach(() => {
            mock.onGet(`http://${blaiseApiUrl}/api/v2/serverparks/${serverpark}/questionnaires/${QuestionnaireMockObject.name}`).reply(200,
            QuestionnaireMockObject,
            );
        });
    ...
    describe("installquestionnaire", () => {
        ...
        beforeEach(() => {
            mock.onPost(`http://${blaiseApiUrl}/api/v2/serverparks/${serverpark}/questionnaires`).reply(201,
    ...
    describe("delete questionnaire", () => {
        ...
        beforeEach(() => {
            mock.onDelete(`http://${blaiseApiUrl}/api/v2/serverparks/${serverpark}/questionnaires/${questionnaireName}?name=${questionnaireName}`).reply(204,
                null,
            );
        });
