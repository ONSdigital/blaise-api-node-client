...
describe('blaiseApiClient', () => {
  ...
  describe('add daybatch', () => {
    ...
    beforeEach(() => {
      mock.onPost(`http://${blaiseApiUrl}/api/v2/cati/serverparks/${serverpark}/questionnaires/${questionnaireName}/daybatch`).reply(
        201,
  ...
  describe('add survey days', () => {
    ...
    beforeEach(() => {
      mock.onPost(`http://${blaiseApiUrl}/api/v2/cati/serverparks/${serverpark}/questionnaires/${questionnaireName}/surveydays`).reply(
        201,
        SurveyDaysMock,
      );
    });
